...
void	NinjaTrap::set_dmg(void)
{
	ClapTrap::set_dmg(60, 5, 0);
}
/*=======================================================*/
	//	Operation Overload
...
void	NinjaTrap::ninjaShoebox(NinjaTrap& trap)
{
	if (trap.get_hp() <= 0)
	{
		std::cout << "<" << trap.get_name() << ">'s is dead, I don't want to Rage on..." << std::endl;
		return ;
	}
	else if ((rand() % 100) > 70)
	{
...
void	NinjaTrap::ninjaShoebox(ClapTrap& trap)
{
	...
	if (this->get_ep() >= 50)
	{
		this->ClapTrap::set_ep(get_ep() - 50);
...
void	NinjaTrap::ninjaShoebox(FragTrap& trap)
{
	...
	if (this->get_ep() >= 25)
	{
		this->ClapTrap::set_ep(get_ep() - 25);
